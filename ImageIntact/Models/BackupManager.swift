...
extension BackupManager {
    ...
    nonisolated static func sha256ChecksumStatic(for fileURL: URL, shouldCancel: Bool, isNetworkVolume _: Bool = false) throws -> String {
    ...
    private nonisolated static func calculateNativeChecksum(for fileURL: URL, shouldCancel: Bool = false) throws -> String {
    ...
    private nonisolated static func calculateStreamingChecksum(for fileURL: URL, size _: Int64, shouldCancel: Bool = false) throws -> String {
