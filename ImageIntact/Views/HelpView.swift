                ...
                ScrollView {
                        ...
                        VStack(alignment: .leading, spacing: 12) {
                            ...
                            VStack(alignment: .leading, spacing: 8) {
                                HelpPoint(title: "Organization Folder", 
                                         description: "Files are organized into a folder you specify (e.g., 'Photos 2025')")
                                
                                HelpPoint(title: "Automatic Migration", 
                                         description: "Existing loose files are automatically moved into the organized folder")
                                
                                HelpPoint(title: "Smart Detection", 
                                         description: "Recognizes files that were previously backed up without organization")
                                
                                HelpPoint(title: "Safe Migration", 
                    ...
                    HelpSection(title: "Notifications & System Integration") {
                        VStack(alignment: .leading, spacing: 12) {
                            ...
                            VStack(alignment: .leading, spacing: 8) {
                                HelpPoint(title: "Sleep Prevention", 
                                         description: "Your Mac stays awake during backups (can be disabled in Preferences)")
                                
                                HelpPoint(title: "Completion Notifications", 
                                         description: "Get notified when backups complete, even if app is in background")
                                
                                HelpPoint(title: "Smart Drive Detection", 
                                         description: "Warns when selecting memory cards as destinations")
                                
                                HelpPoint(title: "Drive Type Recognition", 
                    ...
                    HelpSection(title: "Troubleshooting") {
                        VStack(alignment: .leading, spacing: 12) {
                            ...
                            HelpPoint(title: "Bookmark Errors", 
