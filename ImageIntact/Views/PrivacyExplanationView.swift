      ...
      ScrollView {
        VStack(alignment: .leading, spacing: 20) {
          ...
          VStack(alignment: .leading, spacing: 12) {
            ...
            Text(
              "Path anonymization protects your privacy when sharing diagnostic logs with support or posting them online. It automatically replaces personal information in file paths with generic placeholders."
            )
            .font(.system(size: 12))
          ...
          VStack(alignment: .leading, spacing: 12) {
            ...
            VStack(alignment: .leading, spacing: 8) {
              ...
              Label(
                "Prevents location tracking through file paths", systemImage: "location.slash.fill"
              )
              .font(.system(size: 12))
            }
          }
          ...
          GroupBox {
            HStack(spacing: 12) {
              ...
              VStack(alignment: .leading, spacing: 4) {
                ...
                Text(
                  "Keep this setting enabled (default) to protect your privacy when sharing logs."
                )
                .font(.system(size: 11))
                .foregroundColor(.secondary)
              }
