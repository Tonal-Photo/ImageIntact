...
struct BackupCompletionView: View {
    ...
    var body: some View {
        ...
        .onAppear {
            ...
            ApplicationLogger.shared.debug("Cached report on appear: \(cachedReport.count) characters", category: .ui)
        }
    ...
    private func copyReportToClipboard() {
        ...
        ApplicationLogger.shared.debug("Copy Report - Report length: \(report.count) characters", category: .ui)
