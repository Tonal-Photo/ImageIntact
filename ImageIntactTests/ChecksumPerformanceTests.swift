...
final class ChecksumPerformanceTests: XCTestCase {
    ...
    func testSmallFilePerformance() throws {
        ...
        self.measure {
            _ = try! ChecksumService.sha256(for: file5MB, shouldCancel: { false })
        }
    }
    ...
    func testMediumFilePerformance() throws {
        ...
        self.measure {
            _ = try! ChecksumService.sha256(for: file20MB, shouldCancel: { false })
        }
    }
    ...
    func testLargeFilePerformance() throws {
        ...
        self.measure {
            _ = try! ChecksumService.sha256(for: file100MB, shouldCancel: { false })
        }
    }
    ...
    func testVeryLargeFilePerformance() throws {
        ...
        self.measure {
            _ = try! ChecksumService.sha256(for: file500MB, shouldCancel: { false })
        }
    }
    ...
    func testStreamingVsDirectComparison() throws {
        ...
        _ = try ChecksumService.sha256(for: file9MB, shouldCancel: { false })
        let time9 = CFAbsoluteTimeGetCurrent() - start9
        
        // Time 11MB (streaming)
        let start11 = CFAbsoluteTimeGetCurrent()
        _ = try ChecksumService.sha256(for: file11MB, shouldCancel: { false })
    ...
    func testMemoryUsageForLargeFile() throws {
        ...
        self.measure {
            _ = try! ChecksumService.sha256(for: file200MB, shouldCancel: { false })
        }
    }
}