...
class ImageIntactTests: IsolatedDefaultsTestCase {
    ...
    func testChecksumConsistency() throws {
        ...
        let checksum1 = try ChecksumService.sha256(for: testFile, shouldCancel: { false })
    ...
    func testFileExistsCheckBeforeCopy() throws {
        ...
        let sourceChecksum = try ChecksumService.sha256(for: sourceFile, shouldCancel: { false })
        let destChecksum = try ChecksumService.sha256(for: destFile, shouldCancel: { false })
